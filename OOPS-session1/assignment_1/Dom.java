...
public class Dom 
{
	...
	/**
	 * Searches for ID in composite elements
	 * 
	 * @param tag
	 * @param id
	 * @return element
	 ...
	 */
	private List <Element> AddElementByClass (Element tag, String className) 
	{
		// List contains tags
		List <Element> list = new ArrayList <Element> ();
	 ...
	 * 
	 * @param elementList - the composite element
